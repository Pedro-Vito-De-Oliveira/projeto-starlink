    ...
    def _seed_planos(self) -> list[Plano]:
        ...
        return [
            ...
            Plano(
                ...
                finalidade="Residencial",
                velocidade_mbps=250,
                descricao="Cobertura residencial com alta velocidade nos EUA e Canadá.",
            ),
            Plano(
                nome="Starlink Business",
                preco=500.0,
            ...
            Plano(
                ...
                finalidade="Residencial",
                velocidade_mbps=220,
                descricao="Plano residencial para cobertura na União Europeia e UK.",
            ),
            Plano(
                nome="Starlink Business",
                preco=450.0,
            ...
            Plano(
                ...
                finalidade="Marítimo",
                velocidade_mbps=300,
                descricao="Cobertura marítima no Mar Mediterrâneo e Atlântico Norte.",
            ),
            # ── África ───────────────────────────────────────────────────
            Plano(
                nome="Starlink Residencial",
                ...
                finalidade="Residencial",
                velocidade_mbps=180,
                descricao="Conectividade residencial para regiões remotas africanas.",
            ),
            Plano(
                nome="Starlink Business",
                preco=480.0,
            ...
            Plano(
                ...
                finalidade="Residencial",
                velocidade_mbps=200,
                descricao="Cobertura residencial para regiões rurais e ilhas asiáticas.",
            ),
            Plano(
                nome="Starlink Móvel",
                preco=165.0,
                ...
                finalidade="Móvel",
                velocidade_mbps=150,
                descricao="Serviço de internet em movimento para toda a região da Ásia.",
            ),
        ]
